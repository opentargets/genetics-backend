...
create table if not exists ot.d2v2g_scored engine MergeTree partition by (lead_chrom)
order by (lead_pos, lead_ref, lead_alt, gene_id) as
select study_id,
  pmid,
  pub_date,
  pub_journal,
