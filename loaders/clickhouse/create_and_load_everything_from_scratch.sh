...
root_path=$(pwd)
base_path="gs://genetics-portal-output/190504"
...
gsutil cat "${base_path}/v2d_credset/part-*" | zcat |  clickhouse-client -h 127.0.0.1 --query="insert into ot.v2d_credset_log format JSONEachRow "
